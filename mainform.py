...
class user_mainWindow(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("C++程序设计实验课-智能证件照生成系统-史一栋-赵刚")
        ...
        #self.last_label.setGeometry(220, 240, 600, 500)
        ...
        self.download_pic.setGeometry(QtCore.QRect(1275, 650, 280, 100))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(15)
        self.download_pic.setFont(font)
        self.download_pic.setStyleSheet("border-image:url(down.png)")
    ...
    def click_white(self):
        if(self.sourcefile_path==""):
            QMessageBoim = Image.open(path).warning(self,
                                "警告",
                                "请先上传图片",
                                QMessageBox.Yes)
        else:
